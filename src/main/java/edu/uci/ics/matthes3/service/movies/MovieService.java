package edu.uci.ics.matthes3.service.movies;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.matthes3.service.movies.configs.MovieConfigs;
import edu.uci.ics.matthes3.service.movies.configs.ConfigsModel;
...
public class MovieService {
    ...
    private void connectToDatabase() {
        ...
        switch (movieConfigs.getDbDriver().toLowerCase()) {
            case "mysql":
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.matthes3.service.movies.resources");
